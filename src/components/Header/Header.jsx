            ...
            <header className="w-11/12 mx-auto pt-16 pb-4">
                <nav className="flex justify-between items-center px-4 py-4 border-b-2 rounded-sm top-0 fixed w-11/12 mx-auto backdrop-blur-sm bg-white/50">
                 ...
                 <ul className="hidden md:flex gap-4">
                  ...
                  <button className="py-1 px-3 rounded-md shadow-lg border-2 font-bold flex justify-center items-center gap-1"><span>0 </span> Coin <span> <img className="w-6 rounded-full" src="/src/assets/image/coin.png" alt="" /> </span></button>
                 </nav>
                </nav>
